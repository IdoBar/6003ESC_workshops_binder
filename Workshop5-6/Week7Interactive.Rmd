...
To run R and RStudio for this workshop on Binder (with all packages pre-installed), click on this badge - [![Launch Rstudio Binder](https://static.mybinder.org/badge_logo.svg){width=125px}](https://mybinder.org/v2/gh/IdoBar/6003ESC_workshops_binder/main?urlpath=rstudio){target="_blank"}.
