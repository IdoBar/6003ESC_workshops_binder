...
Using Binder is as simple as clicking on the Binder badge - [![Launch Rstudio Binder](http://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/IdoBar/6003ESC_workshops_binder/main?urlpath=rstudio){target="_blank"}.  
Alternatively, you can navigate to the [Binder](https://mybinder.org/){target="_blank"} homepage and enter the URL of this tutorial [GitHub repository](https://github.com/IdoBar/6003ESC_workshops_binder.git){target="_blank"} `https://github.com/IdoBar/6003ESC_workshops_binder.git` and click on the **launch** buton (see screenshot in `r figs(name="binder",display="cite")` below).
